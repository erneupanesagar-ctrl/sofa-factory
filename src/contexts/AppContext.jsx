...
export function AppProvider({ children }) {
  ...
  const initializeApp = async () => {
    try {
      ...
      if (currentUser) {
        ...
        // Auto-login as System Admin for development
        const adminUser = {
          id: 'admin-001',
          username: 'admin',
          name: 'System Admin',
          role: 'admin',
          permissions: ['VIEW_ALL_LOCATIONS', 'MANAGE_USERS', 'MANAGE_INVENTORY', 'MANAGE_SALES', 'MANAGE_PRODUCTION']
        };
      ...
      // Auto-login as System Admin on error
      const adminUser = {
        id: 'admin-001',
        username: 'admin',
        name: 'System Admin',
  ...
  const loadAppData = async () => {
    try {
      ...
      // Load all data (admin has access to everything)
      await loadAllData();
    } catch (error) {
